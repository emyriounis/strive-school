  ...
  return (
    <div className="dashboard p-4">
      ...
      <ListGroup className="w-100 mt-4 rounded">
        <DashboardItem
          title="Creator Mode"
          subtitle="Grow your audience and get discovered by highlighting content on your profile"
          icon="bi bi-megaphone-fill mr-3"
        />
        <DashboardItem
          title="My Network"
          subtitle="Manage your connections, events and interests"
          icon="bi bi-people-fill mr-3"
        />
        <DashboardItem
          title="Salary Insights"
          subtitle="See how your salary compares to others in the community"
          icon="bi bi-cash mr-3"
        />
        <DashboardItem
          title="My Items"
          subtitle="Keep track of your jobs, courses and articles"
          icon="bi bi-bookmark-fill mr-3"
        />
      </ListGroup>
    </div>
  );

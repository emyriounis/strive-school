    ...
    <>
      <Card>
        ...
        <ListGroup variant="flush" className="d-flex">
          ...
          <div className="d-flex">
            <p className="pl-3 pt-1 text_muted ">View of your post</p>
          </div>
      ...
      <Card className="mt-2">
        <Card.Body>
          ...
          <ListGroup>
            <div className="d-flex">
              <BsPeopleFill />
              <p className="text_muted pl-2">Intership Japan</p>{" "}
            </div>
            <div className="d-flex">
              <BsPeopleFill />
              <p className="text_muted pl-2">React Developer-ReactJS...</p>
            </div>
            <div className="d-flex">
              <BsPeopleFill />
              <p className="text_muted pl-2">Angular, React, Vue, Node, I...</p>
            </div>
            <div className="d-flex">
              <BsPeopleFill />
              <p className="text_muted pl-2">UI/UX User Experience Inter...</p>
            </div>
            <div className="d-flex">
              <BsPeopleFill />
              <p className="text_muted pl-2">iOS Developer Group</p>
            </div>
            {/* </div> */}
          </ListGroup>
